...
import 'package:cu1/models/booking_datetime_converted.dart';
...
class _BookingPageState extends State<BookingPage> {
  ...
  String? token; //get token for insert booking
            ...
            child: Container(
              ...
              child: Button(
                ...
                onPressed: () async {
                  ...
                  //post using dio
                  //pass details together with doctor id and token
                  final booking = await DioProvider().bookAppointment(
                      getDate, getDay, getTime, doctor['doctor_id'], token!);

                  if (booking == 200) {
                    //press button here to store booking details
